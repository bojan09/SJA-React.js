...
import MoviesFuncComp from "./components/MoviesFuncComp.js";
import MoviesClassComp from "./components/MoviesClassComp.js";
  ...
  return (
    <div className="App">
      <div className="homework-1">
        <h1>Homework #1</h1>
        <LifeCycleClassComponent incrementor={incrementor} />
        <LifeCycleFunctionalComponent incrementor={incrementor} />
      </div>

      <div className="homework-2">
        <h1>Homework #2</h1>
        <h1 className="component__heading">Movies Functional Component</h1>
        <div className="container">
          {movies.map((movie) => (
            <MoviesFuncComp movies={movie} />
          ))}
        </div>
        <br />
        <br />
        <h1 className="component__heading">Movies Class Component</h1>
        <div className="container">
          {movies.map((movie) => (
            <MoviesClassComp movies={movie} />
          ))}
        </div>
      </div>
    </div>
